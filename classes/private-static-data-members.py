# PRIVATE CLASS VARIABLES(STATIC) CAN'T BE ACCESSED OUTSIDE OF IT'S CLASS WITHOUT A PUBLIC INTERFACE

# THE PUBLIC INTERFACES TO ACCESS THE CLASSES'S STATIC DATA MEMBERS ARE ALSO STATIC, WHICH MEANS THAT THEY ARE ALSO MEMBERS OF THE CLASS. 
# THEY DO NOT OPERATE OVER AN OBJECT.
# CLASSES'S PUBLIC INTERFACES ARE NOT ATTACHED TA SPECIFIC OBJECT, SO THE self/this, WHICH CONTAINS THE OBJECTS's REFERENCE, IS NOT PRESENT
...
class Car:
    ...
    def change_class_wheels(self, amount): #BOUND/ATTACHED TO A OBJECT
        __MAX_WHEELS = amount # __MAX_WHEELS IS A LOCAL VARIABLE
        print(__MAX_WHEELS)
    
    def change_class_wheels_using_name(self, amount): #BOUND/ATTACHED TO A OBJECT
        Car.__MAX_WHEELS = amount
...
lambo.change_class_wheels_using_name(56) # CHANGE THE CLASS'S STATE/VARIABLE
